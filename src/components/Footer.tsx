        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="text-sm text-white/70 leading-relaxed max-w-xs">
              Elevating your living spaces with premium furniture and timeless design. Bring heaven to your home.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              ...
              <li><Link href="/products?category=furniture" className="hover:text-[var(--accent)] transition-colors">Furniture</Link></li>
              <li><Link href="/products?category=decor" className="hover:text-[var(--accent)] transition-colors">Home Decor</Link></li>
              <li><Link href="/products?category=lighting" className="hover:text-[var(--accent)] transition-colors">Lighting</Link></li>
            </ul>
          </div>
